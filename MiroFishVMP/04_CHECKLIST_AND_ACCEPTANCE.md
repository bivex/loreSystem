...
- [x] есть explicit narrow auto-merge layer для safe duplicate merge cases: `batch/auto-merge` + `safe_existing_location_duplicate_only` / `safe_existing_rumor_duplicate_only`
