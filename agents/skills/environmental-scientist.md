...
**OpenClaw Subagent** - Extracts environmental system entities including weather patterns, atmosphere, lighting conditions, time periods, disasters, and general environmental settings.
