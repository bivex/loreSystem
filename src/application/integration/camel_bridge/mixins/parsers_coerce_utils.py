...
from .parsers_coerce_base import CoerceParserMixin as CoerceParserBaseMixin
from .parsers_coerce_extra import CoerceParserExtraMixin


class CoerceParserMixin(CoerceParserBaseMixin, CoerceParserExtraMixin):
    pass
